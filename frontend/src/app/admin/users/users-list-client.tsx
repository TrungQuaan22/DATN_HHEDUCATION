      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        {canCreateTeacher && (
          <button
            ...
            className="bg-admin-pink text-white px-6 py-2.5 rounded font-bold text-sm flex items-center gap-2 hover:shadow-lg hover:shadow-admin-pink/20 hover:brightness-110 active:scale-95 transition-all cursor-pointer font-sans"
            type="button"
          >
            <Plus size={16} />
            Tạo giảng viên mới
