...
export default function FinalCTA() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    alert(`Đăng ký thành công cho: ${formData.fullName} - ${formData.phone} (Môn: ${formData.subject})`);
  };

  return (
    <section className="py-24 bg-deep-black relative overflow-hidden border-t border-border-dark" id="contact">
      ...
      <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10">
        ...
        <div className="flex flex-col justify-center space-y-8">
          ...
          <p className="text-[20px] text-muted-taupe leading-relaxed">
            Nhận tư vấn lộ trình học tập miễn phí và bộ tài liệu độc quyền dành riêng cho bạn.
          </p>
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              <div className="text-[14px] text-muted-taupe uppercase font-semibold">Hotline hỗ trợ</div>
        ...
        {/* Form Column */}
        <div className="bg-brand-dark p-8 md:p-12 rounded-xl border border-border-dark shadow-l4">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="text-[12px] font-semibold text-muted-taupe uppercase">Họ và tên</label>
              <input
            ...
            <div className="space-y-2">
              <label className="text-[12px] font-semibold text-muted-taupe uppercase">Số điện thoại</label>
              <input
                className="w-full bg-surface-input border border-border-dark rounded-md focus:ring-brand-pink focus:border-brand-pink text-cream p-3 text-[14px] outline-none transition-all focus:ring-1"
            ...
            <div className="space-y-2">
              <label className="text-[12px] font-semibold text-muted-taupe uppercase">Môn học quan tâm</label>
            ...
            <button
              className="w-full bg-brand-pink text-white font-bold text-[14px] py-4 rounded-xl shadow-l4 hover:opacity-90 transition-all active:scale-[0.98] cursor-pointer"
              type="submit"
            >
              Đăng ký ngay
            </button>
