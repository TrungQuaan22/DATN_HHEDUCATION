      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-12 gap-4">
          <div className="text-center md:text-left">
            <h2 className="text-4xl font-[700] text-cream mb-2">
              Khóa học tiêu biểu
            </h2>
            <p className="text-base text-muted-taupe">
              Lộ trình học tập từ lớp 10 đến lớp 12
            </p>
          </div>
          <Link
            href="/courses"
            className="bg-surface-input border border-border-dark px-6 py-2 rounded-full text-cream text-sm font-medium flex items-center gap-2 hover:bg-brand-pink/10 hover:border-brand-pink transition-all"
          >
