...
export default function AboutSection() {
  ...
  return (
    <section
      className="py-24 bg-brand-dark border-t border-border-dark"
      id="about"
    >
      <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
        ...
        <div className="bg-deep-black border border-border-dark rounded p-12 relative overflow-hidden group shadow-l2">
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((serv, idx) => (
            ...
            >
              <div
                className={`w-12 h-12 rounded-md flex items-center justify-center mb-6 ${serv.iconBgClass}`}
              >
                {serv.icon}
              </div>
