      ...
      <div className="bg-deep-black border border-border-dark rounded w-full max-w-lg overflow-hidden shadow-2xl animate-in scale-in-95 duration-200 flex flex-col">
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4 p-4 rounded bg-brand-dark border border-border-dark">
            <div>
              <span className="text-xs text-muted-text block uppercase font-bold">
                Thời gian làm bài
              </span>
        ...
        <div className="px-6 py-4 bg-off-black border-t border-border-dark/40 flex justify-end gap-3">
          <button
            type="button"
            onClick={onClose}
            className="px-5 py-2.5 rounded border border-border-dark bg-deep-black text-xs font-bold text-cream hover:text-brand-pink transition-colors cursor-pointer"
          >
            Hủy bỏ
          </button>
          <button
            ...
            className="px-5 py-2.5 rounded bg-brand-pink text-brand-dark hover:scale-105 active:scale-95 font-extrabold text-xs transition-all cursor-pointer"
          >
            Bắt đầu làm bài
          </button>
        </div>
