  ...
  return (
    ...
    >
      <div className="min-h-0 flex-1 space-y-1.5 overflow-y-auto pr-1">
        <div className="text-[10px] font-bold text-admin-muted uppercase tracking-wider mb-2">
          Mục lục câu hỏi
        </div>
        {items.map((item) => (
          <button
      ...
      <div className="pt-3 border-t border-admin-border/60 space-y-2 shrink-0">
        <div className="text-[10px] font-bold text-admin-muted uppercase tracking-wider">
          Thêm mới
        </div>
        <div className="rounded-lg border border-admin-border/77 bg-admin-bg p-2.5 space-y-2">
          <div className="grid grid-cols-2 gap-2">
            <div className="space-y-1">
              <label className="text-[9px] font-bold uppercase text-admin-muted">Dạng</label>
              <select
                value={bulkItemType}
                disabled
                onChange={(e) => {
                ...
                className="w-full rounded border border-admin-border bg-admin-deep px-2 py-1.5 text-[11px] font-bold text-admin-cream outline-none disabled:cursor-not-allowed disabled:opacity-70"
              >
            ...
            <div className="space-y-1">
              <label className="text-[9px] font-bold uppercase text-admin-muted">Số câu</label>
              <input
                type="number"
                min={1}
                max={100}
                ...
                className="w-full rounded border border-admin-border bg-admin-deep px-2 py-1.5 text-[11px] font-bold text-admin-cream outline-none focus:border-admin-pink"
              />
            </div>
          </div>
          <div className="grid grid-cols-[1fr_auto] gap-2">
            <div className="space-y-1">
              <label className="text-[9px] font-bold uppercase text-admin-muted">
                Điểm mỗi câu
              </label>
              <input
                type="number"
            ...
            <button
              ...
              className="self-end rounded border border-admin-pink/50 bg-admin-pink px-2.5 py-1.5 text-[11px] font-black text-admin-bg transition hover:brightness-110 active:scale-95 cursor-pointer"
            >
              Thêm
            </button>
          </div>
          <div className="space-y-1">
            <label className="text-[9px] font-bold uppercase text-admin-muted">Chuyên đề</label>
            <input
              type="text"
          ...
          <div className="text-[10px] leading-relaxed text-admin-muted">
        ...
        <div>
          <button
            ...
            className="flex w-full items-center justify-center gap-1 rounded bg-admin-deep border border-admin-border py-1.5 text-[10px] font-bold text-admin-cream hover:border-admin-pink transition cursor-pointer"
          >
