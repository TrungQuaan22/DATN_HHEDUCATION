...
def run_rag_tutor(
    ...
    for index, row in enumerate(rows, start=1):
        chunk_id, content, chunk_lesson_id, source_type, material_title, base_similarity, score = row
